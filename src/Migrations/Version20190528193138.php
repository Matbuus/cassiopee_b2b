 ...
 */
final class Version20190528193138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, city, postal, address FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER NOT NULL, localisation_id INTEGER NOT NULL, type_evenement_id INTEGER NOT NULL, etat_evenement_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, date DATE NOT NULL, lat DOUBLE PRECISION NOT NULL, lng DOUBLE PRECISION NOT NULL, city VARCHAR(255) NOT NULL COLLATE BINARY, postal INTEGER NOT NULL, address VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_B26681E19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B26681EC68BE09C FOREIGN KEY (localisation_id) REFERENCES localisation (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B26681E88939516 FOREIGN KEY (type_evenement_id) REFERENCES type_evenement (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_B26681E170A1CCC FOREIGN KEY (etat_evenement_id) REFERENCES etat (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO evenement (id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, city, postal, address) SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, city, postal, address FROM __temp__evenement');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_B26681E88939516');
        $this->addSql('DROP INDEX IDX_B26681E170A1CCC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, address, city, postal FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER NOT NULL, localisation_id INTEGER NOT NULL, type_evenement_id INTEGER NOT NULL, etat_evenement_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, date DATE NOT NULL, lat DOUBLE PRECISION NOT NULL, lng DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL, city VARCHAR(255) NOT NULL, postal INTEGER NOT NULL)');
        $this->addSql('INSERT INTO evenement (id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, address, city, postal) SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date, lat, lng, address, city, postal FROM __temp__evenement');
        $this->addSql('DROP TABLE __temp__evenement');
        $this->addSql('CREATE INDEX IDX_B26681E19EB6921 ON evenement (client_id)');
        $this->addSql('CREATE INDEX IDX_B26681EC68BE09C ON evenement (localisation_id)');
        $this->addSql('CREATE INDEX IDX_B26681E88939516 ON evenement (type_evenement_id)');
