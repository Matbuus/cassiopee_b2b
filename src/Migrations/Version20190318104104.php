 ...
 */
final class Version20190318104104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__metier AS SELECT id, titre FROM metier');
        $this->addSql('DROP TABLE metier');
        $this->addSql('CREATE TABLE metier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO metier (id, titre) SELECT id, titre FROM __temp__metier');
        ...
        $this->addSql('CREATE TABLE partenaire (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, prestation_proposee_id INTEGER DEFAULT NULL, metiers_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_32FFA373DCF28B17 FOREIGN KEY (metiers_id) REFERENCES metier (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_32FFA3732E4D1423 FOREIGN KEY (prestation_proposee_id) REFERENCES prestation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__metier AS SELECT id, titre FROM metier');
        $this->addSql('DROP TABLE metier');
        $this->addSql('CREATE TABLE metier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, partenaires_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO metier (id, titre) SELECT id, titre FROM __temp__metier');
        $this->addSql('DROP TABLE __temp__metier');
