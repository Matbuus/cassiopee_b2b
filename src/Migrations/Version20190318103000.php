 ...
 */
final class Version20190318103000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__type_evenement AS SELECT id, nom FROM type_evenement');
        $this->addSql('DROP TABLE type_evenement');
        $this->addSql('CREATE TABLE type_evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO type_evenement (id, nom) SELECT id, nom FROM __temp__type_evenement');
        $this->addSql('DROP TABLE __temp__type_evenement');
        $this->addSql('DROP INDEX IDX_C74404559E13E9F5');
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, nom, prenom FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO client (id, nom, prenom) SELECT id, nom, prenom FROM __temp__client');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, titre, date FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, date DATE NOT NULL)');
        $this->addSql('INSERT INTO evenement (id, titre, date) SELECT id, titre, date FROM __temp__evenement');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__metier AS SELECT id, partenaires_id, titre FROM metier');
        $this->addSql('DROP TABLE metier');
        $this->addSql('CREATE TABLE metier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, partenaires_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_51A00D8C38898CF5 FOREIGN KEY (partenaires_id) REFERENCES partenaire (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO metier (id, partenaires_id, titre) SELECT id, partenaires_id, titre FROM __temp__metier');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE portail_b2b (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, nom, prenom FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, portail_b2b_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO client (id, nom, prenom) SELECT id, nom, prenom FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('CREATE INDEX IDX_C74404559E13E9F5 ON client (portail_b2b_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, titre, date FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, date DATE NOT NULL, portail_b2b_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO evenement (id, titre, date) SELECT id, titre, date FROM __temp__evenement');
        $this->addSql('DROP TABLE __temp__evenement');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__metier AS SELECT id, partenaires_id, titre FROM metier');
        $this->addSql('DROP TABLE metier');
        $this->addSql('CREATE TABLE metier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, partenaires_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, portail_b2b_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO metier (id, partenaires_id, titre) SELECT id, partenaires_id, titre FROM __temp__metier');
        $this->addSql('DROP TABLE __temp__metier');
        $this->addSql('CREATE INDEX IDX_51A00D8C38898CF5 ON metier (partenaires_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__partenaire AS SELECT id, prestation_proposee_id, nom, prenom FROM partenaire');
        $this->addSql('DROP TABLE partenaire');
        $this->addSql('CREATE TABLE partenaire (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, prestation_proposee_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO partenaire (id, prestation_proposee_id, nom, prenom) SELECT id, prestation_proposee_id, nom, prenom FROM __temp__partenaire');
        $this->addSql('DROP TABLE __temp__partenaire');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_32FFA3732E4D1423 ON partenaire (prestation_proposee_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__type_evenement AS SELECT id, nom FROM type_evenement');
        $this->addSql('DROP TABLE type_evenement');
        $this->addSql('CREATE TABLE type_evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, portail_b2b_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO type_evenement (id, nom) SELECT id, nom FROM __temp__type_evenement');
        $this->addSql('DROP TABLE __temp__type_evenement');
