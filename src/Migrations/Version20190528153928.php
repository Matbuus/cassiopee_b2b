 ...
 */
final class Version20190528153928 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__evenement AS SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date FROM evenement');
        $this->addSql('DROP TABLE evenement');
        $this->addSql('CREATE TABLE evenement (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER NOT NULL, localisation_id INTEGER NOT NULL, type_evenement_id INTEGER NOT NULL, etat_evenement_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL, date DATE NOT NULL)');
        $this->addSql('INSERT INTO evenement (id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date) SELECT id, client_id, localisation_id, type_evenement_id, etat_evenement_id, titre, date FROM __temp__evenement');
        $this->addSql('DROP TABLE __temp__evenement');
        $this->addSql('CREATE INDEX IDX_B26681E19EB6921 ON evenement (client_id)');
        $this->addSql('CREATE INDEX IDX_B26681EC68BE09C ON evenement (localisation_id)');
