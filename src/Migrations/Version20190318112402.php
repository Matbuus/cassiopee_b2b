 ...
 */
final class Version20190318112402 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__prestation AS SELECT id, date_debut, date_fin FROM prestation');
        $this->addSql('DROP TABLE prestation');
        $this->addSql('CREATE TABLE prestation (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, CONSTRAINT FK_51C88FAD727ACA70 FOREIGN KEY (parent_id) REFERENCES prestation (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO prestation (id, date_debut, date_fin) SELECT id, date_debut, date_fin FROM __temp__prestation');
