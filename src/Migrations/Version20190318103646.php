 ...
 */
final class Version20190318103646 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__metier AS SELECT id, partenaires_id, titre FROM metier');
        $this->addSql('DROP TABLE metier');
        $this->addSql('CREATE TABLE metier (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, partenaires_id INTEGER DEFAULT NULL, titre VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO metier (id, partenaires_id, titre) SELECT id, partenaires_id, titre FROM __temp__metier');
        $this->addSql('DROP TABLE __temp__metier');
        $this->addSql('CREATE INDEX IDX_51A00D8C38898CF5 ON metier (partenaires_id)');
        $this->addSql('DROP INDEX UNIQ_32FFA3732E4D1423');
